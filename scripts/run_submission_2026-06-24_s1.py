#!/usr/bin/env python3
"""2026-06-24 submission-1: Phase 16 ARC-GEN-fitted color maps."""
...
SEED_DIR = f"{LOGGED_SUB_DIR}/submission"
SEED_ZIP = f"{LOGGED_SUB_DIR}/submission_v2.zip"
BASELINE_TASKS = 70
...
def main():
    ...
    print(f"Seeded {seeded} ONNX from {LOGGED_SUB_DIR}")
    ...
    should_submit = train_only == 0 and (pass_all > BASELINE_TASKS or est >= BASELINE_EST + 1.0)
    print(
    ...
    msg = f"ARC-Genome M10a: {pass_all} verified, est {est:.0f}, arcgen color fit"
