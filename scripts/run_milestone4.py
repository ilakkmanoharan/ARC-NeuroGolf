#!/usr/bin/env python3
"""Milestone 4: third-pass conv + composition depth 4 + gravity solver."""
...
MILESTONE_DIR = "phases/milestone4"
...
def main():
    ...
    print("Milestone 4: third-pass conv + depth-4 composition + gravity...")
    ...
    msg = f"ARC-Genome M4: {n} verified, est {est:.0f}, coverage push"
    ...
    if proc.returncode != 0:
        print("Submit failed — retry: python scripts/submit_m4.py")
        sys.exit(1)
