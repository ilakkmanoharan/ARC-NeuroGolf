#!/usr/bin/env python3
"""Milestone 3: official score selection + 100 ARC-GEN fit + position gather."""
...
MILESTONE_DIR = "phases/milestone3"
...
def main():
    ...
    print("Milestone 3: official score selection + 100 ARC-GEN fit...")
    ...
    if proc.returncode != 0:
        print("Submit failed — retry: python scripts/submit_m3.py")
        sys.exit(1)
